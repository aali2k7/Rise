        ...
        <>
            <header
                className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ease-out
                    ${scrolled
                        ? "bg-white/90 backdrop-blur-xl border-b border-slate-200/50 shadow-sm h-16"
                        : "bg-transparent h-24"
                    }`}
            >
                        ...
                        <Link href="/" className="flex items-center shrink-0 relative z-50">
                            <div className="relative overflow-hidden group">
                                <Image
                                    ...
                                    priority={true}
                                    className="transition-all duration-500 ease-in-out hover:scale-105 [mix-blend-mode:multiply]"
                                />
                            </div>
                        </Link>
