...
export default function FacultySection() {
  ...
  return (
    <section
      id="faculty"
      className="min-h-screen bg-base-light"
    >
      {/* Page Header */}
      <section className="bg-white py-20 border-b border-base-subtle">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-body-lg text-text-secondary max-w-2xl mx-auto">
            Experienced educators committed to student success through clarity,
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-base-subtle">
                    <span className="text-body-sm text-text-secondary block mb-2">
                      Expertise
                    </span>
          ...
          <div className="space-y-8">
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="flex-shrink-0 w-2 h-2 bg-accent-navy rounded-full mt-2" />
