        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-12 xl:col-span-5 relative">
            <motion.div
              ...
              className="relative aspect-square max-w-[340px] mx-auto xl:mx-0 flex items-center justify-center group/logo"
            >
              {/* Internal brand glow */}
          ...
          <div className="lg:col-span-12 xl:col-span-7">
            ...
            >
              ...
              <div className="space-y-6">
                <blockquote className="relative italic font-serif text-xl lg:text-2xl text-slate-400 font-light leading-snug pl-6 border-l-2 border-slate-100">
                  When I started RISE, the goal was simple: to create a space where students are guided with patience, not pressure.
                </blockquote>

                <div className="space-y-5 text-base lg:text-lg text-slate-600 font-medium leading-[1.8]">
                  <p>
