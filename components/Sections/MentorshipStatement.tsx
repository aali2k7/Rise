export default function MentorshipStatement() {
  return (
    <section id="mentorship" className="w-full bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="content-container section-spacing">
        <div className="max-w-4xl">
          ...
          <div className="mt-8 h-px w-24 bg-gradient-to-r from-orange-400 to-orange-600" />
