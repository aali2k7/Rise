...
export default function FacultyCard({ name, role, department, tagline, imageFolder, delay }: FacultyCardProps) {
    // We assume the user will upload 'profile.jpg' into the respective folder down the line.
    const expectedImagePath = `/faculty/${imageFolder}/profile.jpg`;
