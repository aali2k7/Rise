...
export default function NEETCoachingPage() {
    ...
    return (
        <main className="bg-white">
            ...
            {/* WHY FUTURE DOCTORS CHOOSE RISE - image 2 */}
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    <div className="relative order-2 lg:order-1">
                        <div className="aspect-[4/3] bg-[#E2E8F0] rounded-3xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-200 flex items-center justify-center">
                            <span className="text-xl text-slate-400 font-medium">Biology Lab / Class</span>
                        </div>
                        <div className="absolute -bottom-8 -right-4 md:-right-8 bg-white p-6 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.08)] border border-slate-100 flex items-center gap-4">
                            <HeartPulse className="w-10 h-10 text-rose-500" strokeWidth={2.5} />
                            <div>
                                <p className="text-xl font-bold text-slate-900 leading-tight">Dr. Faculty</p>
                                <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mt-1">Expert Mentors</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={i} className="flex gap-5">
                                    <div className="w-12 h-12 rounded-full bg-[#ecfdf5] flex items-center justify-center flex-shrink-0">
